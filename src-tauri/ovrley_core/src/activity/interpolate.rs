...
pub fn densify_activity(
    ...
    DenseActivityReport {
        ...
        series: DenseSeriesReport {
            ...
            estimated_torque: densify(
                &trimmed.sample_elapsed_seconds,
                &trimmed.estimated_torque,
                &frame_elapsed_seconds,
                requirements.torque,
                crate::MetricKind::EstimatedTorque,
            ),
            estimated_power_kw: densify(
                &trimmed.sample_elapsed_seconds,
                &trimmed.estimated_power_kw,
                &frame_elapsed_seconds,
                requirements.torque,
                crate::MetricKind::EstimatedPowerKw,
            ),
            estimated_power_cv: densify(
                &trimmed.sample_elapsed_seconds,
                &trimmed.estimated_power_cv,
                &frame_elapsed_seconds,
                requirements.torque,
                crate::MetricKind::EstimatedPowerCv,
            ),
            estimated_gear: densify(
                &trimmed.sample_elapsed_seconds,
                &trimmed.estimated_gear,
                &frame_elapsed_seconds,
                requirements.torque,
                crate::MetricKind::EstimatedGear,
            ),
