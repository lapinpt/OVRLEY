...
fn metric_kind_from_key(key: &str) -> Option<MetricKind> {
    match key {
        ...
        "estimated_torque" => Some(MetricKind::EstimatedTorque),
        "estimated_power_kw" => Some(MetricKind::EstimatedPowerKw),
        "estimated_power_cv" => Some(MetricKind::EstimatedPowerCv),
        "estimated_gear" => Some(MetricKind::EstimatedGear),
...
fn metric_kind_to_key(kind: MetricKind) -> &'static str {
    match kind {
        ...
        MetricKind::EstimatedTorque => "estimated_torque",
        MetricKind::EstimatedPowerKw => "estimated_power_kw",
        MetricKind::EstimatedPowerCv => "estimated_power_cv",
        MetricKind::EstimatedGear => "estimated_gear",
