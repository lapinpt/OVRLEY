...
#[test]
fn racechrono_v10_vbo_uses_signed_decimal_degree_coordinates() {
    let vbo = "File created on 08/08/2026 at 13:36:02\n\
[header]\n\
time\n\
latitude\n\
longitude\n\
velocity kmh\n\
[comments]\n\
Generated by RaceChrono v10.2.4\n\
[column names]\n\
time lat long velocity\n\
[data]\n\
133602.087 38.0109533 -7.8699542 0\n\
133602.137 38.0109555 -7.8699554 3.6\n";

    let activity = parse_vbo_activity_reader(Cursor::new(vbo), "racechrono-v10.vbo", None)
        .unwrap()
        .parsed_activity;

    assert_eq!(activity.course[0], (Some(38.0109533), Some(-7.8699542)));
    assert_eq!(activity.course[1], (Some(38.0109555), Some(-7.8699554)));
    assert_eq!(activity.speed, vec![Some(0.0), Some(1.0)]);
}
