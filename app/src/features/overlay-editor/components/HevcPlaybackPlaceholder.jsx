    ...
    >
      ...
      >
        ...
        <div className="space-y-2">
          <p className="text-base font-medium text-amber-100">HEVC video cannot be played</p>
        ...
        {isWindows && videoPreviewHelpAvailable ? (
          <div className="max-w-lg space-y-4 text-sm text-amber-200/80">
            <p>You can get the HEVC codec from the Microsoft Store.</p>
            <button
              type="button"
        ...
        {isLinux ? (
          <div className="max-w-lg space-y-4 text-left text-sm text-amber-200/80">
            <p>Install the correct package for your system.</p>
            <p>On Ubuntu:</p>
            <code className="block rounded bg-black/50 px-3 py-2 font-mono text-xs text-amber-100">sudo apt install unrestricted-extra</code>
          </div>
        ) : null}
      </div>
    </div>
