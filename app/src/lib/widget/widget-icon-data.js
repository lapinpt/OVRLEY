...
export const METRIC_ICON_SVGS = {
  ...
  estimated_gear: parseMetricIconSvg(gearPositionIconSvg),
  ...
  estimated_power_kw: parseMetricIconSvg(powerIconSvg),
  estimated_power_cv: parseMetricIconSvg(powerIconSvg),
  ...
  estimated_torque: parseMetricIconSvg(torqueIconSvg),
